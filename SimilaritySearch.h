...
public:
    ...
    void parse_files(short, std::vector<std::string>, std::string,std::map<std::string, QuerySequence>&);
private:
    ...
    void process_best_diamond_hit(std::list<std::map<std::string,QuerySequence>>&);
};
