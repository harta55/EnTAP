...
/* Frame Selection - TransDecoder Commands */
        {INI_FRAME_TRANSDECODER,CMD_TRANS_LONG_EXE,ENTAP_INI_NULL ,DESC_TRANS_LONG_EXE        ,ENTAP_INI_NULL   ,ENT_INI_VAR_STRING      ,TRANSDECODER_LONG_DEFAULT_EXE, ENT_RUN_PARAM_INI_FILE   ,ENTAP_INI_NULL_VAL},
        {INI_FRAME_TRANSDECODER,CMD_TRANS_PREDICT_EXE,ENTAP_INI_NULL,DESC_TRANS_PREDICT_EXE   ,ENTAP_INI_NULL   ,ENT_INI_VAR_STRING      ,TRANSDECODER_PREDICT_DEFAULT_EXE, ENT_RUN_PARAM_INI_FILE,ENTAP_INI_NULL_VAL},
...
UserInput::UserInput(int argc, const char** argv, FileSystem *fileSystem) {
    ...
    if (generated_ini) {
        ...
        throw ExceptionHandler("Both INI files are required for EnTAP execution, missing file has been generated in current directory",
